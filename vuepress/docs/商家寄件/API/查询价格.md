...
curl_setopt_array($ch, [
    CURLOPT_URL => 'http://api.crmeb.net/api/v2/shipment/price',
...
HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create("http://api.crmeb.net/api/v2/shipment/price"))
...
(async () => {
    const response = await fetch('http://api.crmeb.net/api/v2/shipment/price', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer-' + token,
            'Content-Type': 'application/json'
...
func main() {
	...
	req, _ := http.NewRequest("POST", "http://api.crmeb.net/api/v2/shipment/price", strings.NewReader(`{"kuaidicom":"xxx","send_address":"xxx","address":"xxx","weight":"xxx","service_type":"xxx"}`))

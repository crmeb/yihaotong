...
curl_setopt_array($ch, [
    CURLOPT_URL => 'http://sms.crmeb.net/api/v2/shipment/index?kuaidi_num=xxx&courier_name=xxx&page=1&limit=20',
...
HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create("http://sms.crmeb.net/api/v2/shipment/index?kuaidi_num=xxx&courier_name=xxx&page=1&limit=20"))
...
(async () => {
    const response = await fetch('http://sms.crmeb.net/api/v2/shipment/index?kuaidi_num=xxx&courier_name=xxx&page=1&limit=20', {
        headers: {
            'Authorization': 'Bearer-' + token
        }
    });
...
func main() {
	...
	req, _ := http.NewRequest("GET", "http://sms.crmeb.net/api/v2/shipment/index?kuaidi_num=xxx&courier_name=xxx&page=1&limit=20", nil)

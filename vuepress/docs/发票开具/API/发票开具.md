...
curl_setopt_array($ch, [
    CURLOPT_URL => 'http://api.crmeb.net/api/v2/invoice/invoice_issuance/xxx',
...
HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create("http://api.crmeb.net/api/v2/invoice/invoice_issuance/xxx"))
...
(async () => {
    const response = await fetch('http://api.crmeb.net/api/v2/invoice/invoice_issuance/xxx', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer-' + token,
            'Content-Type': 'application/json'
...
func main() {
	...
	req, _ := http.NewRequest("POST", "http://api.crmeb.net/api/v2/invoice/invoice_issuance/xxx", strings.NewReader(`{"is_tax_inclusive":1,"is_enterprise":1,"invoice_type":"xxx","invoice_tspz_type":"xxx","tax_id":"xxx","account_name":"13800138000","bank_name":"xxx","bank_account":"13800138000","telephone":"13800138000","company_address":"xxx","drawer":"xxx","amount":"xxx","goods":[{"store_name":"xxx","unit_price":"xxx","nature_type":"xxx","num":"xxx","sku":"xxx","unit":"xxx","tax_rate":"xxx","amount":"xxx","tax_price":"xxx","cate_id":"xxx","cate_name":"xxx"}],"remark":"xxx","show_bank_account":1,"show_sale_account":1}`))

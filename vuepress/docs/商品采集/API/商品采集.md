...
curl_setopt_array($ch, [
    CURLOPT_URL => 'http://sms.crmeb.net/api/v2/copy/goods',
...
HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create("http://sms.crmeb.net/api/v2/copy/goods"))
        .header("Authorization", "Bearer-" + token)
        .header("Content-Type", "application/json")
        .POST(HttpRequest.BodyPublishers.ofString("{\"url\":\"https://www.example.com\"}"))
        .build();
...
(async () => {
    const response = await fetch('http://sms.crmeb.net/api/v2/copy/goods', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer-' + token,
            'Content-Type': 'application/json'
...
func main() {
	...
	req, _ := http.NewRequest("POST", "http://sms.crmeb.net/api/v2/copy/goods", strings.NewReader(`{"url":"https://www.example.com"}`))
